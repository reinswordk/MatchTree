...
public class BoardManager : MonoBehaviour
{
   ...
   public Vector2 offSetBoard;
    ...
    [Header("Tile")]
    public List<Sprite> tilesTypes = new List<Sprite>();
    ...
    private void CreateBoard(Vector2 tileSize)
    {
        ...
        for (int x = 0; x < size.x; x++)
        {
            ...
            {
                TileController newTile = Instantiate(tilePrefab, new Vector2
                    (startPosition.x + ((tileSize.x + offSetTile.x) * x),
    ...
    private void ProcessMatches()
    {
        ...
        combo++;
        TimeManager.Instance.Bonustime(3);
